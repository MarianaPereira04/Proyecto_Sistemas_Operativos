...
export default function FcfsDiskPage() {
  ...
  const handleSubmit = async (requests: number[], head: number) => {
    ...
    try {
      const res = await fetch('http://localhost:3015/algorithms/disco/fcfs', {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">FCFS Disco — First-Come, First-Served</h1>
        <p className="text-gray-400">
          Atiende las solicitudes de acceso a disco en el orden exacto en el que llegaron a la cola, sin optimización de distancias.
        </p>
      </div>
