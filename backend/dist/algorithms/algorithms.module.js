...
const algorithms_controller_1 = require("./algorithms.controller");
...
exports.AlgorithmsModule = AlgorithmsModule = __decorate([
    (0, common_1.Module)({
        controllers: [algorithms_controller_1.AlgorithmsController],
        providers: [algorithms_service_1.AlgorithmsService]
    })
], AlgorithmsModule);
